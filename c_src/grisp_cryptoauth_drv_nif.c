...
static ErlNifFunc nif_funcs[] = {
    {"init_device",         1, init_device_nif,      ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"sleep_device",        1, sleep_device_nif,     ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"device_info",         1, device_info_nif,      ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"config_locked",       1, config_locked_nif,    ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"data_locked",         1, data_locked_nif,      ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"slot_locked",         2, slot_locked_nif,      ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"serial_number",       1, serial_number_nif,    ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"read_config",         1, read_config_nif,      ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"write_config",        1, write_config_nif,     ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"lock_config",         1, lock_config_nif,      ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"lock_data",           1, lock_data_nif,        ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"lock_slot",           2, lock_slot_nif,        ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"gen_private_key",     2, gen_private_key_nif,  ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"gen_public_key",      2, gen_public_key_nif,   ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"sign",                3, sign_nif,             ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"verify_extern",       4, verify_extern_nif,    ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"verify_stored",       4, verify_stored_nif,    ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"write_comp_cert",     3, write_comp_cert_nif,  ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"read_comp_cert",      2, read_comp_cert_nif,   ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"gen_random_bytes",    1, gen_random_bytes_nif, ERL_NIF_DIRTY_JOB_IO_BOUND},
};
